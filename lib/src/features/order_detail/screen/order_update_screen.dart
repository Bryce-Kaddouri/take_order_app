...
class OrderUpdateScreen extends StatefulWidget {
  ...
  OrderUpdateScreen({super.key, required this.orderId, required this.orderDate});
  @override
  State<OrderUpdateScreen> createState() => _OrderUpdateScreenState();
}

class _OrderUpdateScreenState extends State<OrderUpdateScreen> with fluent.TickerProviderStateMixin {
                      ...
                      children: [
                        fluent.Button(
                            ...
                            onPressed: currentStep == 0
                                ...
                                : () {
                                    if (currentStep > 0) {
                                      pageController.animateToPage(int.parse(pageController.page.toString()) - 1, duration: Duration(milliseconds: 300), curve: Curves.easeIn);
                                      if (currentStep == 1) {
                                        _animationControllerProgressBar.animateTo(1.5);
                              ...
                              if (currentStep == 0) {
                                ...
                                if (orderModel != null) {
                                  ...
                                  UpdateOrderParam updateOrderParam = UpdateOrderParam(
                                    ...
                                    time: orderModelAsync.time.hour != newDate.hour || orderModelAsync.time.minute != newDate.minute ? TimeOfDay(hour: newDate.hour, minute: newDate.minute) : null,
                                    actionMap: actionMap,
                                      ...
                                      itemBuilder: (context, index) {
                                        return fluent.ListTile(
                                          ...
                                          trailing: fluent.Row(
                                            ...
                                            children: [
                                              fluent.IconButton(
                                                ...
                                                icon: const fluent.Icon(fluent.FluentIcons.remove),
                                              ),
                                          ...
                                          onPressed: () async {
                                            ...
                                            final formKeyQty = GlobalKey<FormState>();
                                              ...
                                              builder: (context) => fluent.ContentDialog(
                                                ...
                                                actions: [
                                                  ...
                                                  fluent.FilledButton(
                                                    child: const Text('Confirm'),
                                                    onPressed: () {
                                                      if (formKeyQty.currentState!.validate()) {
                          ...
                          fluent.Row(
                            children: [
                              fluent.Container(
                                ...
                                child: const fluent.Icon(fluent.FluentIcons.date_time),
                              ),
                              const fluent.SizedBox(
                                width: 10,
                              ),
                                  ...
                                  child: fluent.Row(
                                    children: [
                                      fluent.Container(
                                        ...
                                        child: const fluent.Icon(fluent.FluentIcons.contact),
                                      ),
                                      const fluent.SizedBox(
                                        width: 10,
                                      ),
                                  ...
                                  child: fluent.Row(
                                    children: [
                                      fluent.Container(
                                        ...
                                        child: const fluent.Icon(fluent.FluentIcons.phone),
                                      ),
                                      const fluent.SizedBox(
                                        width: 10,
                                      ),
